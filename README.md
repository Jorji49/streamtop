...
Latest release: **[v0.3.4](https://github.com/Jorji49/streamtop/releases/tag/v0.3.4)** (`streamtop --version`).
...
| Area | Contents |
|------|----------|
| Status | URL, LIVE / ESTIMATED, SHI, FPS, GOP / audio badges, latency, CDN, buffer, LL-HLS |
